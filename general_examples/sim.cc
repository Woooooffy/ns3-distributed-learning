...
int main(int argc, char *argv[]) {
    ...
    link_helper1.ConnectSwitches(sw0, sw1);
		...
		/// TODO: manual code below

		
		const std::string LOG_FILE = "<path_to_log>";
		std::string XML_ALGO = ns3::SystemPath::Append(ns3::SystemPath::FindSelfDirectory(), "<path_to_schedule>");
		...
		// flow Id testing for switch forwarding
