...
NS_LOG_COMPONENT_DEFINE("ScclExample1");

constexpr int N_NODES = 8;

constexpr std::array<std::pair<int, int>, 24> edges = {{
    {0, 1}, {0, 1}, {0, 2}, {0, 3}, {0, 3}, {1, 2},
    {1, 3}, {2, 3}, {2, 3}, {4, 5}, {4, 5}, {4, 6},
    {4, 7}, {5, 6}, {5, 6}, {5, 7}, {6, 7}, {6, 7},
    {0, 5}, {3, 6}, {1, 4}, {1, 4}, {2, 7}, {2, 7}
}}; // undir graph
...
const std::string LOG_FILE = "/data/commit/graphit/wangyj05/workspace/gloo-ns3-examples/logs/sccl1-alltoall.txt";
...
main(int argc, char* argv[])
{
    ...
    for (int i = 0; i < N_NODES; ++i) {
		...
		edge.SetDeviceAttribute("DataRate", StringValue("25Gbps")); // 25Gbps usually, 10000bps for lowbw test
